...
if __name__ == "__main__":
    ...
    '''
    # 项目跟路径:
    dir_root = r'D:\Coding\python\DeepLearning\Object_Detection\Public\A_New_model'
    # 训练好的模型路径
    model_path = r'logs\loss_43287812250\best_epoch_weights.pth'
    #------------------------------------------------------------------------------------------------------------------#
    ...
    image_ids = open(os.path.join('VOCdevkit', "VOC2007/ImageSets/Main/test.txt")).read().strip().split()
    ...
    if map_mode == 0 or map_mode == 1:
        ...
        for image_id in tqdm(image_ids):
            image_path  = os.path.join(VOCdevkit_path, "all_images/"+image_id+".jpg")
    ...
    if map_mode == 0 or map_mode == 2:
        ...
        for image_id in tqdm(image_ids):
            with open(os.path.join(map_out_path, "ground-truth/"+image_id+".txt"), "w") as new_f:
                root = ET.parse(os.path.join(VOCdevkit_path, "all_xml/"+image_id+".xml")).getroot()
