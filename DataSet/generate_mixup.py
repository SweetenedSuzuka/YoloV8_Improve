...
if __name__ == "__main__":
    ...
    for index in range(Out_Num):
        ...
        img.save(os.path.join(Out_JPEGImages_path, "ZZ_mixup_" + str(index) + '.jpg'))
        write_xml(os.path.join(Out_Annotations_path, "ZZ_mixup_" + str(index) + '.xml'), os.path.join(Out_JPEGImages_path, str(index) + '.jpg'), \
